...
struct FVoxelListByDistanceResponse : ICrowdyQueryResponse
{
	...
	virtual void ParseResponse(const TSharedPtr<FJsonObject>& JsonObject) override
	{
		...
		for (auto& ChunkData : *ChunksArray)
		{
			...
			{
				UE_LOG(LogCrowdyNet, Warning, TEXT("Failed to get chunk object"));
				continue;
			}
			...
			{
				UE_LOG(LogCrowdyNet, Warning, TEXT("Chunk coordinates not found"));
				continue;
			}
			...
			{
				UE_LOG(LogCrowdyNet, Warning, TEXT("Failed to extract chunk coordinates"));
				continue;
			}
			...
			{
				UE_LOG(LogCrowdyNet, Warning, TEXT("Failed to extract voxels array for chunk %lld, %lld, %lld"),
			...
			for (auto& VoxelData : *VoxelsArray)
			{
				...
				{
					UE_LOG(LogCrowdyNet, Warning, TEXT("Failed to get voxel object"));
					continue;
				}
				...
				{
					UE_LOG(LogCrowdyNet, Warning, TEXT("Voxel location not found"));
					continue;
				}
				...
				{
					UE_LOG(LogCrowdyNet, Warning, TEXT("Failed to extract voxel data"));
					continue;
				}
				...
				{
					UE_LOG(LogCrowdyNet, Warning, TEXT("Failed to parse timestamp from response"));
				}
